        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-8 md:mb-0 animate-slide-in-left">
            ...
            <p className="text-lg text-gray-600 mb-6">
              Discover amazing products from talented women entrepreneurs across Rwanda. 
              Support local businesses and find unique items that tell a story.
            </p>
            <Button className="bg-purple hover:bg-purple-600 text-white px-8 py-3 text-lg rounded-full">
              Shop Now
            </Button>
          </div>
          <div className="md:w-1/2 flex justify-center animate-fade-in">
            <div className="relative">
              <img 
                src="https://images.unsplash.com/photo-1594736797933-d0c56ba4faa0?q=80&w=500&h=600&fit=crop"
